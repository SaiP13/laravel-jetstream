                ...
                <div class="text-center text-sm text-gray-500">
                    <div class="flex items-center">
                        ...
                        @if (Route::has('login'))
                            ...
                            @auth
                            <a href="{{ url('/dashboard') }}" class="text-md text-gray-400 underline">Dashboard</a>
                            @else


                            <a href="{{ route('login') }}" class="text-md text-gray-400 underline">  Log in </a>

                            @if (Route::has('register'))

                            <a href="{{ route('register') }}"
                                class="ml-4 text-md text-gray-400 underline"> Register </a>
                            @endif
                            @endauth
